<footer class="bg-white pt-16">
    ...
    <div class="text-center px-4 mb-10">
        <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4">KAMI HADIR UNTUK <span class="text-green-600">KALIAN!</span></h2>
        <p class="text-gray-700 mb-6">Memberikan Solusi tepat untuk memajukan kelompok tani winongo asri</p>
        <ul class="text-left max-w-xl mx-auto space-y-3 text-gray-700">
    ...
    <div class="bg-lime-300 py-6 rounded-t-3xl">
        <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex items-center space-x-3 mb-4 md:mb-0">
                <img src="{{ asset('images/logo.png') }}" alt="BO TANI Logo" class="w-12 h-12">
